...
class CtxFuncsReady
{
    ...
    public $dirPluginCt = __DIR__ . DIRECTORY_SEPARATOR .'..'. DIRECTORY_SEPARATOR .'..'. DIRECTORY_SEPARATOR;
    public $config;
    public $argv;
    ...
    {
        return "You can view the list of commands by typing: 'php ctx -clist' \r";
    }

    public function loadDefaultMessage()
    {
        return "\r
WELCOME TO CREATIVE TOOLBOX EXECUTE \r
=================================== \r
...
=================================== \r
\r
1. For help you can typing 'php ctx -h' or 'php ctx -help' \r
2. For command list typing 'php ctx -clist'\r\n". PHP_EOL;
...
\r
(1). Welcome CTX \r 
\033[32m Command: [php ctx] \033[0m
This command for welcome message. \r
----------------------------------- \r
(2). Help \r 
\033[32m Command: [php ctx -h] or [php ctx -help] \033[0m \r
----------------------------------- \r
(3). Create Local Server \r 
\033[32m Command: [php ctx serve] \033[0m (default port: 9876 and directory location is wordpress root)  \r
or \r
\033[32m Command: [php ctx serve <set port> '<set root directory>'] \033[0m \r
----------------------------------- \r
(4). Create MVC (Model-View-Controller) \r 
\033[32m Command: [php ctx -create -mvc '<model name>' '<view name>' '<controller name>'] \033[0m \r
----------------------------------- \r
(5). Create Model \r 
\033[32m Command: [php ctx -create -model '<model name>'] \033[0m \r
----------------------------------- \r
(6). Create View \r 
\033[32m Command: [php ctx -create -view '<view name>'] \033[0m \r
----------------------------------- \r
(7). Create Controller \r 
\033[32m Command: [php ctx -create -controller '<controller name>'] \033[0m \r
----------------------------------- \r
(8). Create Library \r 
\033[32m Command: [php ctx -create -library '<library name>'] \033[0m \r
----------------------------------- \r
(9). Create Helper \r 
\033[32m Command: [php ctx -create -helper '<helper name>'] \033[0m \r
----------------------------------- \r
(10). Create Starter \r 
\033[32m Command: [php ctx -create -starter '<starter name>'] \033[0m \r
----------------------------------- \r
(11). Add Routing \r 
- Add Parent Routing Page Menu
\033[32m Command: [php ctx -routing -add -parent '<slug name>' <int position>] \033[0m \r

- Add Sub Routing Page Menu
\033[32m Command: [php ctx -routing -add -sub '<sub slug name>' <int position> '<parent slug name>'] \033[0m \r
...
----------------------------------- \r
    ...
    public function serve($setPort = null, $specDir = null)
    {
        ...
        $specDir = $specDir !== null && trim($specDir) !== '' ? $specDir : __DIR__ ."{$this->ds}..{$this->ds}..{$this->ds}..{$this->ds}..{$this->ds}..{$this->ds}";
...
class ". ucfirst($avModelName) ." extends CT_model
{
    public \$db;
...
class ". ucfirst($avControllerName) ." extends CT_controller
{

    public function __construct()
    {
        \$this->". ucfirst($avModelName) ." = \$this->model('". ucfirst($avModelName) ."');
...
Please insert Helper name. \r\n ". $this->ctxInfoList();
        ...
        // ADD SOMETHING
            ...
            echo $this->msgOprtErr("You can view the list of commands by typing: 'php ctx -clist'", "$createAct");
        }
    }
...
Please insert page menu type (-parent or -sub). \r\n ". $this->ctxInfoList();
            ...
            if ($avPageMenuName !== null && $avPageMenuName !== '') {
                ...
                if (
                    ...
                    $filePageMenu = $this->dirPluginCt . $this->config['config_path'] .'menuPages.php';
...
#-ctxgenerate";
                            ...
                            $setPageMenuContent = str_replace(
                                '#-ctxgenerate', $newContentPageMenu, $getContentPageMenu
                            );
...
#-ctxgenerate";
                        ...
                        echo "
Failed open Page Menu config (pageMenu.php). Error Code :1 \r\n ". $this->ctxInfoList();
                    }

                }else{
                    echo "
Page Menu config (pageMenu.php) not exists. \r\n ". $this->ctxInfoList();
                }
